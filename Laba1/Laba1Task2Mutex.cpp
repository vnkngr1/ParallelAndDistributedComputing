//============================================================================
// Name        : Laba1Task2Mutex.cpp
// Author      : Garshin Ivan
// Description : Конкурентное накопление суммы массива с std::mutex
...
void sumInRange(int start, int end, int& result, const std::vector<int>& nums, boost::mutex& mutex) {
    ...
    // Блокируем мьютекс для добавления результатов
