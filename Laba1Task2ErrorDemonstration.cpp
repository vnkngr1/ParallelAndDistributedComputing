//============================================================================
// Name        : Laba1Task2ErrorDemonstration.cpp
// Author      : Garshin Ivan
// Description : Конкурентное накопление суммы массива с демонстраицей ошибки синхронизации
...
void sumInRange(int start, int end, int& result, const std::vector<int>& nums) {
...
void vectorGenerator(int size, std::vector<int>& vec) {
    ...
    std::uniform_int_distribution<> dist(0, 999); // Диапазон [0, 999]
